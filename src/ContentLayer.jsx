...
const ContentLayer = () => {
    ...
    return (
        <div ref={containerRef} style={{ position: 'relative', zIndex: 10, backgroundColor: '#fafafa', width: '100%', overflow: 'hidden' }}>
            ...
            <div ref={phiRef} style={{ height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '0 5vw', backgroundColor: '#fafafa' }}>
                ...
                <div style={glassStyle}>
                    ...
                    <div style={{ flex: 1, borderRight: '1px solid rgba(0,0,0,0.05)', paddingRight: '20px' }}>
                        ...
                        <svg viewBox="0 0 400 100" style={{ width: '100%', height: 'auto', overflow: 'visible' }}>
                            ...
                            <path className="path-m-etch" d="M 0 50" fill="none" stroke="white" strokeWidth="2.5" opacity="0.5" style={{ transform: 'translate(0.5px, 1px)' }} />
                            {/* Base Path (Dark) */}
                    ...
                    <div style={{ flex: 1, paddingLeft: '20px' }}>
                        ...
                        <svg viewBox="0 0 400 100" style={{ width: '100%', height: 'auto', overflow: 'visible' }}>
                            ...
                            {/* Etched Path */}
                            <path className="path-e-etch" d="M 0 50" fill="none" stroke="white" strokeWidth="2.5" opacity="0.5" style={{ transform: 'translate(0.5px, 1px)' }} />
